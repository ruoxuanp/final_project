...
def read_econdb(api): #read in layoff rate from EconDB
    ...
    filtered = [d for d in list_of_dicts if "2013" <= d['date'][:4] <= "2022"]
...
def read_unemployment():
    ...
    filtered_month_unemploy = [d for d in month_unemploy if "2013" <= d['date'][:4] <= "2022"]
...
def read_cpi():
    ...
    # filter the data in the range from 2001 to 2022
    filtered_month_cpi = [d for d in month_cpi if "2013" <= d['date'][:4] <= "2022"]
...
def read_ir_non_marketable():
    ...
    filtered_l = [d for d in l if "2013" <= d['date'][:4] <= "2022"]
